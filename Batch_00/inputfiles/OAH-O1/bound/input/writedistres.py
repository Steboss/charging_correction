...
host_atoms = ["CLP:C45","CLP:C63","CLP:C57","CLP:C51"] 
guest_atoms = ["C4"]
...
distres = "distance restraints dictionary = {(%s,%s):(6.00,10.0,2.00), (%s,%s):(6.00,10.0,2.00),(%s,%s):(6.00,10.0,2.00), (%s,%s):(6.00,10.0,2.00) }" % \
